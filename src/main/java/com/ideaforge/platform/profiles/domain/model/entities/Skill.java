...
import com.ideaforge.platform.profiles.domain.model.valueobjects.ProficiencyLevel;
...
@NoArgsConstructor
@Entity
public class Skill extends AuditableModel {
    @Id
    ...
    public Skill(Profile profile, String name) {
